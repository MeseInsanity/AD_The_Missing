...
function applyNDMultipliers(mult, tier) {
  ...
  // Each first-row achievement affects its tier and every lower-tier Dimension.
  for (let rewardTier = tier; rewardTier <= 8; rewardTier++) {
    multiplier = multiplier.times(Achievement(rewardTier + 10).effectOrDefault(1));
  }
